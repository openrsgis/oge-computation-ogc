...
//    loadLandsat8()
  ...
  def test1(implicit sc: SparkContext):Unit={
    val c = CoverageCollection.load(sc,"ASTER_GDEM_DEM30",null, startTime = "2000-01-01 00:00:00",endTime = "2000-01-01 00:00:00",extent = Extent(110, 18.1, 111, 18.5))

//    val c1 = CoverageCollection.map(sc,c,"addNum",100)
    val c2 = CoverageCollection.mosaic(c)
    makeTIFF(c2,"add")
    println("Finish")
  }
