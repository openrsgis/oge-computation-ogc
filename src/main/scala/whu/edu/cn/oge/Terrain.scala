...
object Terrain {
  ...
  def slope(coverage: (RDD[(SpaceTimeBandKey, Tile)], TileLayerMetadata[SpaceTimeKey]),
  ...
  def aspect(coverage:(RDD[(SpaceTimeBandKey, Tile)], TileLayerMetadata[SpaceTimeKey]),
