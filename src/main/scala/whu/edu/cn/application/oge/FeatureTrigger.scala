...
object FeatureTrigger {
  ...
  def func(implicit sc: SparkContext, UUID: String, name: String, args: Map[String, String]): Unit ={
    ...
    if(name=="Feature.difference"){
      if(argOrNot(args,"crs")!=null)
        rdd_list+=(UUID->Feature.difference(rdd_list(args("featureRDD1")).asInstanceOf[RDD[(String,(Geometry, Map[String, Any]))]],
          rdd_list(args("featureRDD2")).asInstanceOf[RDD[(String,(Geometry, Map[String, Any]))]],args("crs")))
      else
        rdd_list+=(UUID->Feature.difference(rdd_list(args("featureRDD1")).asInstanceOf[RDD[(String,(Geometry, Map[String, Any]))]],
          rdd_list(args("featureRDD2")).asInstanceOf[RDD[(String,(Geometry, Map[String, Any]))]]))
    ...
    if(name=="Feature.intersection"){
      if(argOrNot(args,"crs")!=null)
        rdd_list+=(UUID->Feature.intersection(rdd_list(args("featureRDD1")).asInstanceOf[RDD[(String,(Geometry, Map[String, Any]))]],
          rdd_list(args("featureRDD2")).asInstanceOf[RDD[(String,(Geometry, Map[String, Any]))]],args("crs")))
      else
        rdd_list+=(UUID->Feature.intersection(rdd_list(args("featureRDD1")).asInstanceOf[RDD[(String,(Geometry, Map[String, Any]))]],
          rdd_list(args("featureRDD2")).asInstanceOf[RDD[(String,(Geometry, Map[String, Any]))]]))
    ...
    if(name=="Feature.symmetricDifference"){
      if(argOrNot(args,"crs")!=null)
        rdd_list+=(UUID->Feature.symmetricDifference(rdd_list(args("featureRDD1")).asInstanceOf[RDD[(String,(Geometry, Map[String, Any]))]],
          rdd_list(args("featureRDD2")).asInstanceOf[RDD[(String,(Geometry, Map[String, Any]))]],args("crs")))
      else
        rdd_list+=(UUID->Feature.symmetricDifference(rdd_list(args("featureRDD1")).asInstanceOf[RDD[(String,(Geometry, Map[String, Any]))]],
          rdd_list(args("featureRDD2")).asInstanceOf[RDD[(String,(Geometry, Map[String, Any]))]]))
    ...
    if(name=="Feature.union"){
      if(argOrNot(args,"crs")!=null)
        rdd_list+=(UUID->Feature.union(rdd_list(args("featureRDD1")).asInstanceOf[RDD[(String,(Geometry, Map[String, Any]))]],
          rdd_list(args("featureRDD2")).asInstanceOf[RDD[(String,(Geometry, Map[String, Any]))]],args("crs")))
      else
        rdd_list+=(UUID->Feature.union(rdd_list(args("featureRDD1")).asInstanceOf[RDD[(String,(Geometry, Map[String, Any]))]],
          rdd_list(args("featureRDD2")).asInstanceOf[RDD[(String,(Geometry, Map[String, Any]))]]))
  ...
  def main(args: Array[String]): Unit ={
    ...
    a=a:+("00001","Feature.lineString",Map("coors" -> "[[20,20],[25,30],[40,37]]", "properties" -> properties))
    ...
    lamda(sc,a)
    println(rdd_list("0000").asInstanceOf[Double])
    println(rdd_list("0001").asInstanceOf[Double])
    ...
    println(rdd_list("0010").asInstanceOf[RDD[Array[Coordinate]]].first())
    println(rdd_list("0011").asInstanceOf[RDD[(String,(Geometry, Map[String, Any]))]].first()._2._1.toText)
    println(rdd_list("0012").asInstanceOf[RDD[Boolean]].first())
    println(rdd_list("0013").asInstanceOf[RDD[Boolean]].first())
    println(rdd_list("0014").asInstanceOf[RDD[String]].first())
    println(rdd_list("0015").asInstanceOf[RDD[String]].first())
    println(rdd_list("0016").asInstanceOf[RDD[String]].first())
    println(rdd_list("0017").asInstanceOf[RDD[String]].first())
    println(rdd_list("0018").asInstanceOf[RDD[Double]].first())
    println(rdd_list("0019").asInstanceOf[RDD[Double]].first())
    ...
    println(rdd_list("0028").asInstanceOf[Geometry].toText)
    println(rdd_list("0029").asInstanceOf[Geometry].toText)
    println(rdd_list("0030").asInstanceOf[Geometry].toText)
    println(rdd_list("0031").asInstanceOf[Geometry].toText)
    println(rdd_list("0032").asInstanceOf[Boolean])
    println(rdd_list("0033").asInstanceOf[Boolean])
    println(rdd_list("0034").asInstanceOf[Geometry].toText)
    println(rdd_list("0035").asInstanceOf[Geometry].toText)
    println(rdd_list("0036").asInstanceOf[Geometry].toText)
    println(rdd_list("0037").asInstanceOf[Geometry].toText)
