...
class GeoCorrection {
   ...
   */
  def geometricCorrection(sc: SparkContext, inputFileArr: Array[String], outPutDir: String, outputSuf: Boolean = true): Unit = {
...
object GeoCorrection {
  def main(args: Array[String]): Unit = {
    ...
    correction_alg.geometricCorrection(sc, input_file_arr, outputImgPath)
  ...
  def geometricCorrection(sc: SparkContext, inputFileArr: Array[String], outPutDir: String, outputSuf: Boolean = true): Unit = {
    val correction_alg = new GeoCorrection()
    correction_alg.geometricCorrection(sc, inputFileArr, outPutDir, outputSuf)
  }
}
